...
export const scorecard: Score[] = [
  ...
  { aspect: "Accessibility", current: 96, target: 96, note: "AT TARGET. Full WCAG-AA re-audit across every shipped page (incl. new pillars): single h1 + clean heading outline, all images alt'd, form controls labelled with aria-invalid/aria-describedby, no mobile overflow at 375px. Token-verified text contrast (muted 6.0:1, brand-800/eyebrow 6.1:1, error red 6.5:1). Every focus-visible:outline-none pairs a ring. Skip link, aria-current/expanded/controls, Escape handling, landmarks, reduced-motion honored. Fixed in this pass: contact success card role=\"status\" (4.1.3), founder section labels promoted to h2 to close an h1→h3 skip." },
