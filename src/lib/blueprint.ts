...
export const phases: Phase[] = [
  ...
  },
  {
    ...
    items: ["Academy", "Research", "Products"],
  },
  {
    id: "5",
...
export const scorecard: Score[] = [
  ...
  { aspect: "SEO", current: 88, target: 97, note: "GATED (Phases 2–3): infrastructure 100% — sitemap/robots/schema graph/OG image (verified 200 png)/canonical. Final points require the content pages Google will rank." },
  ...
  { aspect: "Content depth", current: 86, target: 95, note: "Homepage + Projects (6) + Services + About + full Founder page + Contact (+form) live, bilingual. All P0 pages shipped. Founder-portfolio project case studies now carry the FULL documentation set from the personal portfolio, bilingual: banana 15, beans 11, pedal 16, wheelbarrow 9, braking 4, fsae 1 (hero, illustrative). Remaining pages: Academy, Research, Products (P1)." },
